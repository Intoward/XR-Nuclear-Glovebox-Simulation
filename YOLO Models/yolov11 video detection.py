...
output_path = r"C:\Users\rosej\Documents\Quickstart Project\yolo output\video output\output_video.mp4" # !!Replace with output path and user name!!
...
while True:
    ...
    cv2.imshow("YOLOv11 Video Processing", annotated_frame)
